...
<div class="container "> <!-- Div principal -->
    ...
    <form action="{{url('/usuario/registro')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                @if(isset($email))
                <input class="form-control NoRadiusGray" id="email" name="email" type="email" placeholder="" value="{{$email}}" disabled required>
                @else
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                @if(isset($codigo))
                    <input class="form-control NoRadiusGray" id="codigo_cliente" name="codigo_cliente" type="text" placeholder="" value="{{$codigo}}" disabled required>
                @else
...
<!--
        <div class="form-group">
            <label for="opcion1" class="control-label col-md-3 ClassThin">Tipo de usuario</label>
            <div class="col-md-6">
                <select class="form-control NoRadiusGray" name="Tuser" id="Tuser">
...
<!--
        <div class="form-group" id="CV">
            <label for="foto" class="control-label col-md-3 ClassThin" ClassThin>Adjunte CV en PDF no mayor a 10 Mb</label>
            <br>
