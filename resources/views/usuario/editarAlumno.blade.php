...
<center>
    <h3 class="cssTitleRegistro">EDITAR ALUMNO</h3>
</center>
<br><br><br>
<div class="container "> <!-- Div principal -->
    ...
    <form action="{{url('/usuario/editaralumnoregistro')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <input  id="idCA" name="idCA" type="hidden" value="{{$cve_ca}}" required>
                <input class="form-control NoRadius" id="nombre" name="nombre" type="text" placeholder="" value="{{$alumno->Nombre}}" required>
            </div>
        </div>
        <div class="form-group">
            <label for="apaterno" class="control-label col-md-3 whiteClass">Apellido Paterno</label>
            <div class="col-md-6">
                <input class="form-control NoRadius" id="apaterno"  name="apaterno" type="text" placeholder="" value="{{$alumno->APaterno}}" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input class="form-control NoRadius" id="amaterno" name="amaterno" type="text" placeholder="" value="{{$alumno->AMaterno}}" required>
            </div>
        </div>
        <div class="form-group">
