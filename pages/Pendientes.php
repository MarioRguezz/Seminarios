...
<div class="container">
    ...
    <tr class="info">        
        ...
        <td><center> <button type="submit" class="info"> <span class="glyphicon glyphicon-info-sign"></span> </button></center></td>
        </form>
        ...
        <td><center> <button class="btn btn-success" id="btn-autoriza" type="submit">Aprobar &nbsp; <span class="glyphicon glyphicon-ok"></span></button> </center></td>
        </form>
...
if($accion == '4pr0v@r')
{
	...
	if(mysql_query($consultados, $conec))
	{		}
	else
	{
	...
	if(mysql_query($consultatres,$conec))
	{		
			/*		
