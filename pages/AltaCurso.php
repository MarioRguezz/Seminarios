...
$res= get_Personas();
	...
	$resultass = mysql_query($queryzex);		
	$rows = mysql_fetch_array($resultass);			
...
<label for="nombre" class="control-label col-md-3">Nombre del curso*</label>
    <div class="col-md-6">
    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre del curso" required>
    </div>
</div>
...
<div class="form-group">
 ...
 <div class="form-group">
 	<label class="control-label col-md-3">Su ID como instructor del curso* </label>
    <div class="col-md-3">
    	<input class="form-control" id="autocomplete" name="IDinstructor" type="text" placeholder="Matricula del instructor:" required value="<?PHP echo htmlentities($Matricula); ?>" readonly>
    </div>
 </div>
...
<label for="nombre" class="control-label col-md-3">Descripción*</label>
    <div class="col-md-6">
    <textarea class="form-control" maxlength="200" id="Descrip" name="Descripcion" placeholder="Introduzca una breve descripción del curso" required></textarea>
    </div>
</div>
                
<div class="form-group">
	<div class="col-md-2 col-md-offset-2">
		<button class="btn btn-success" id="btn-registro" type="submit">Crear curso &nbsp; <span class="glyphicon glyphicon-ok"></span></button>
...
if($accion == 'Nu3v@')
		{
			...
			$Consulta = "INSERT INTO curso_instructor (id_Curso, Mat_Usuario) VALUES ($IDCurso, '$_POST[IDinstructor]');";
						...
						{
							echo "hubo un error al ejecuta query curso_instructor intente de nuevo".mysql_error();
						}
			...
			$Consulta = "INSERT INTO curso_informacion (ID_Curso, per_num, Descrip) VALUES ($IDCurso, '$_POST[Cupo]', '$_POST[Descripcion]');";
						...
						{
							echo "hubo un error al ejecuta query curso_información intente de nuevo".mysql_error();
						}
				
				$sql = "INSERT INTO curso (id_Curso, nombre, estatus) VALUES ($IDCurso, '$_POST[nombre]', 'ALTA');";
				
				if(mysql_query($sql,$conec))
				{				
					/*
